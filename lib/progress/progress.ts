...
const Settings: any = (NProgress.settings = {
  minimum: 0.08,
  easing: 'linear',
  positionUsing: '',
  speed: 200,
...
NProgress.configure = function (options: any) {
  var key, value
  for (key in options) {
    value = options[key]
...
NProgress.done = function (force: boolean) {
...
NProgress.inc = function (amount: number) {
...
;(function () {
  ...
  NProgress.promise = function ($promise: any) {
...
NProgress.render = function (fromStart: any) {
...
function barPositionCSS(n: any, speed: any, ease: any) {
  let barCSS: any = {}
...
var css = (function () {
  ...
  function applyCss(element: HTMLElement, prop: any, value: any) {
    prop = getStyleProp(prop)
    element.style[prop] = value
  }

  return function (element: any, properties: any) {
    var args = arguments,
      prop,
      value
...
function hasClass(element: any, name: string) {
